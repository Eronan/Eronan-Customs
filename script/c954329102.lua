--Reguraptor Eagle Glida
local s,id=GetID()
function s.initial_effect(c)
	--synchro summon
	Synchro.AddProcedure(c,nil,1,1,aux.FilterBoolFunctionEx(Card.IsRace,RACE_WINGEDBEAST),1,99)
	c:EnableReviveLimit()
	--search
...
function s.thfilter(c)
	return c:IsLevelBelow(7) and c:IsRace(RACE_WINGEDBEAST) and c:IsAbleToHand()
end
