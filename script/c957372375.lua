...
function s.initial_effect(c)
	--Rune Summon
	c:EnableReviveLimit()
	Rune.AddProcedure(c,aux.FilterBoolFunction(Card.IsType,TYPE_RUNE),2,99,aux.FilterBoolFunctionEx(Card.IsSetCard,0xfeb),1,1,nil,nil,nil,nil,s.rune_custom_check)
