...
function s.initial_effect(c)
	--Rune Summon
	c:EnableReviveLimit()
	Rune.AddProcedure(c,aux.FilterBoolFunction(Card.IsAttribute,ATTRIBUTE_WATER),1,1,nil,1,1,LOCATION_GRAVE)
	--spsummon
...
function s.spfilter(c,e,tp)
	return c:IsType(TYPE_RUNE) and c:IsAttribute(ATTRIBUTE_WATER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
