...
function s.initial_effect(c)
	--Rune Summon
	c:EnableReviveLimit()
	Rune.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsAttribute,ATTRIBUTE_DARK),2,2,aux.FilterBoolFunctionEx(Card.IsType,TYPE_PENDULUM),1,1,LOCATION_GRAVE+LOCATION_REMOVED)
