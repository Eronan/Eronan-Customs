--Primordial Beast Great Eel
if not Rune then Duel.LoadScript("proc_rune.lua") end
local s,id=GetID()
function s.initial_effect(c)
	--Rune Summon
	c:EnableReviveLimit()
	Rune.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsRuneCode,902245100),1,1,aux.FilterBoolFunctionEx(Card.IsType,TYPE_FIELD),1,1)
