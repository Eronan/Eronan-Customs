...
function s.initial_effect(c)
	--Rune Summon
	c:EnableReviveLimit()
	Rune.AddProcedure(c,aux.NOT(aux.FilterBoolFunctionEx(Card.IsType,TYPE_TOKEN)),1,1,aux.FilterBoolFunctionEx(Card.IsSetCard,0xfcf),1,1,LOCATION_DECK,nil,nil,s.runchk)
	--banish
